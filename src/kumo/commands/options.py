...
class Option:
    ...
    choices: Sequence[Choice] | None = attrs.field(default=None, repr=True, eq=True)
    ...
    channel_types: Sequence[ChannelType] | None = attrs.field(default=None, repr=False, eq=False)
